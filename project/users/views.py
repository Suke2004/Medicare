...
model_path = 'project/users/diseasepred.pkl'
...
# def find_nearby_hospitals(latitude, longitude, radius=2000):
...
# save_map(hospital_map, os.path.join("project", "static", "hospitals.html"))
...
def data():
    ...
    fetch_for_app()  # Call the function to generate the map
